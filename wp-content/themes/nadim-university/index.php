...
<?php
get_header();// this function will call the header.php file code or pull out the cotent of the header.php file and put it here.
...
get_footer();// this function will call the footer.php file code or pull out the cotent of the footer.php file and put it here.
